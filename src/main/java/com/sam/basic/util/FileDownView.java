...
import com.sam.basic.problem.ProblemImageDto;
...
public class FileDownView extends AbstractView{
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		ProblemImageDto problemImageDto = (ProblemImageDto)model.get("problemImageDto");
...
//		}
		...
		File file = new File(path, problemImageDto.getImageName());
		...
		String downName = problemImageDto.getOriImageName();
